var MINIMUM_ANDROID_VERSION = new Date(2020, 6, 5);
var ANDROID_LAST_UPDATE = new Date(2020, 6, 15);

var MINIMUM_IOS_VERSION = splitOSVersion("13.5.1");
var IOS_LAST_UPDATE = new Date(2020, 5, 1);

var MINIMUM_CHROMEOS_VERSION = splitOSVersion("83.0.4103.119");
var CHROMEOS_LAST_UPDATE = new Date(2020, 5, 24);
